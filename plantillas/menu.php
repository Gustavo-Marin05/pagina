...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary navbar-custom fixed-top">
        <div class="container-fluid">
            <a class="navbar-brand" href="#"><img src="images/logonue.png" alt="Logo" width="40" height="34"> facultad de medicina</a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="nueva2.php">Inicio</a>
                    </li>
